...
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Sigismondo', 'Adrien', 34614307477, 'sadrienj@issuu.com', '$2a$04$91h7n8DPBRRxXs1Czax1tOVRy1Lu8on/Q.8ekMa8haFk4osrgTqpi', 2);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Susanetta', 'Stirley', 34687016590, 'sstirleyk@businesswire.com', '$2a$04$UpVYECsbeCiAFv9o8NO8HOK/0h/48Q59sKDzTHB1m1ainaIIFzWfq', 2);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Allistir', 'Gaukrodge', 34698312296, 'agaukrodgel@sciencedirect.com', '$2a$04$olrX8euXCjPGbGYhnVwMIu/.OcKkMnjTjwKXomRd2P84L3EYvvqRK', 2);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Marge', 'Duhig', 34657308061, 'mduhigm@chronoengine.com', '$2a$04$YXQ/wt.p0399Xvy2qUbqK.RfpyZAWeVUnHcWPdx1fZsroq6T3uBq.', 2);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Massimiliano', 'Bassom', 34697172341, 'mbassomn@youtube.com', '$2a$04$TdKABIJ14cooZsNwM1517ekVhpNhJKft2Amd4X4K8KCVq/fZ4JTtS', 2);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Errol', 'Brownsell', 34616213948, 'ebrownsello@hp.com', '$2a$04$1eGxNrGeDd.0PIyN1tiqZ.PwFOqCcRyxIXt7rcugECGzZhJElr14m', 2);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Fae', 'Scoterbosh', 34632771852, 'fscoterboshp@woothemes.com', '$2a$04$LeWzw3w6YuYXGdidqL5NM.1DbIui/OzE7.rEIvcobEvyiDVvqjO0i', 2);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Rois', 'Baron', 34627863854, 'rbaronq@miibeian.gov.cn', '$2a$04$a38fp5U/QMdTNbbP2ag92uQvja9xRnUZxgXMCZZvHwV8CcYaAFk86', 2);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Dorise', 'Raynes', 34689764181, 'draynesr@icio.us', '$2a$04$TWA6jHRSTHI2cU1DlmIGyu3D7ZLGzt8k90PCnaLmRyiv5iRHxg.gG', 2);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Rosalynd', 'Pirri', 34658397844, 'rpirris@xinhuanet.com', '$2a$04$CZA.ljPatQnhV5JnxD6Ovu0RQdRf1LZ9jYHUJv19HgyoQMWnBLVSK', 2);
-- Insertions of admin users to the users table
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Jessie', 'Effnert', 34618980196, 'jeffnertt@unicef.org', '$2a$04$UcVL6qyJcICeF9VsDsDwrudT4ThvL9aPLvXdcJHdWxMQidDHZHnWW', 3);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Costa', 'Haggerstone', 34679494629, 'chaggerstonei@opera.com', '$2a$04$hamFdzqsvp8Y7pdmYtJWrOjhpWokbMBx67UAeO1gfgSPW6YnGuuK6', 3);
...
-- Insertions of public events
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('Christmas Market in Tarragona', 'Explore the festive market with various stalls and holiday decorations.', 'img/christmas_market_tarragona.jpg', '2023-12-15', '2023-12-23', 0.00, true, 41.1189, 1.2445, 1);
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('Reus Winter Festival', 'Join the winter festivities in Reus with live music, food, and entertainment.', 'img/winter_festival_reus.jpg', '2023-12-10', '2023-12-20', 5.00, true, 41.1544, 1.1063, 2);
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('Salou Christmas Parade', 'Enjoy the magical Christmas parade featuring Santa Claus and colorful floats.', 'img/christmas_parade_salou.jpg', '2023-12-18', '2023-12-18', 0.00, true, 41.0762, 1.1316, 3);
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('Cambrils Ice Skating Extravaganza', 'Experience the joy of ice skating in Cambrils with a beautiful winter setup.', 'img/ice_skating_cambrils.jpg', '2023-12-12', '2023-12-26', 8.00, true, 41.0746, 1.0620, 4);
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('Valls Christmas Choir Concert', 'Immerse yourself in the melodious Christmas choir concert in Valls.', 'img/choir_concert_valls.jpg', '2023-12-22', '2023-12-22', 10.00, true, 41.2880, 1.2445, 5);
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('Three Wise Men Parade in Tarragona', 'Experience the magical parade welcoming the Three Wise Men with colorful floats and celebrations.', 'img/wise_men_parade_tarragona.jpg', '2023-01-05', '2023-01-05', 0.00, true, 41.1189, 1.2445, 1);
-- Insertions of private events
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('Tarragona Beach Hotel Christmas Gala', 'Join us for a festive gala by the beach with live music and a special Christmas dinner.', 'tarragona_beach_hotel_gala.jpg', '2023-12-24', '2023-12-24', 75.00, false, 41.1189, 1.2445, 1);
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('Salou Resort & Spa New Year\'s Spa Retreat', 'Indulge in a luxurious New Year\'s spa retreat at our resort in Salou.', 'salou_resort_spa_new_years_retreat.jpg', '2023-12-31', '2023-12-31', 120.00, false, 41.0762, 1.1316, 3);
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('Valls Historic Inn Masquerade Ball', 'Join us for an elegant masquerade ball at our historic inn in Valls.', 'valls_historic_inn_masquerade_ball.jpg', '2023-12-31', '2023-12-31', 60.00, false, 41.2880, 1.2445, 5);
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('PortAventura Hotel Christmas Gala', 'Experience the magic of Christmas at our festive gala with live music, a gourmet dinner, and holiday decorations.', 'portaventura_hotel_christmas_gala.jpg', '2023-12-24', '2023-12-24', 120.00, false, 41.0876, 1.1668, 6);
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('PortAventura Hotel Christmas Day Brunch', 'Celebrate Christmas Day with a special brunch at PortAventura Hotel, featuring a delicious spread of festive treats.', 'portaventura_hotel_christmas_brunch.jpg', '2023-12-25', '2023-12-25', 80.00, false, 41.0876, 1.1668, 6);
INSERT INTO `events` (title, `description`, img_url, start_date, end_date, entry_price, is_public, latitude, longitude, id_hotel) VALUES ('PortAventura Hotel New Year\'s Eve Celebration', 'Ring in the New Year with an exclusive celebration at PortAventura Hotel, featuring fireworks, live performances, and a festive atmosphere.', 'portaventura_hotel_new_years_eve.jpg', '2023-12-31', '2023-12-31', 150.00, false, 41.0876, 1.1668, 6);
...
INSERT INTO add_favourites (id_hotel, id_user, star_rating) VALUES (1, 1, 4); -- visitor
INSERT INTO add_favourites (id_hotel, id_user, star_rating) VALUES (3, 1, 5); -- visitor
INSERT INTO add_favourites (id_hotel, id_user, star_rating) VALUES (5, 1, 3); -- visitor
INSERT INTO add_favourites (id_hotel, id_user, star_rating) VALUES (6, 1, 4); -- visitor
INSERT INTO add_favourites (id_hotel, id_user, star_rating) VALUES (6, 2, 5); -- visitor
INSERT INTO add_favourites (id_hotel, id_user, star_rating) VALUES (2, 2, 3); -- visitor
INSERT INTO add_favourites (id_hotel, id_user, star_rating) VALUES (4, 2, 1); -- visitor
INSERT INTO add_favourites (id_hotel, id_user, star_rating) VALUES (1, 2, 5); -- visitor
INSERT INTO add_favourites (id_hotel, id_user, star_rating) VALUES (1, 29, 2); -- admin
INSERT INTO add_favourites (id_hotel, id_user, star_rating) VALUES (6, 29, 4); -- admin
...
id_service INT,
PRIMARY KEY(id),
UNIQUE KEY hotel_services_uk (id_hotel, id_service),
FOREIGN KEY (id_hotel) REFERENCES hotels (id) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY (id_service) REFERENCES services (id) ON UPDATE CASCADE ON DELETE CASCADE
);

-- Insertions for the hotel_services table
INSERT INTO hotel_services (id_hotel, id_service) VALUES (1, 1); -- Tarragona Beach Hotel - SPA
INSERT INTO hotel_services (id_hotel, id_service) VALUES (1, 6); -- Tarragona Beach Hotel - Near the beach
INSERT INTO hotel_services (id_hotel, id_service) VALUES (1, 8); -- Tarragona Beach Hotel - Own activities
INSERT INTO hotel_services (id_hotel, id_service) VALUES (2, 3); -- Reus Boutique Hotel - Gym
INSERT INTO hotel_services (id_hotel, id_service) VALUES (3, 1); -- Salou Resort & Spa - SPA
INSERT INTO hotel_services (id_hotel, id_service) VALUES (3, 2); -- Salou Resort & Spa - Swimming Pool
INSERT INTO hotel_services (id_hotel, id_service) VALUES (3, 8); -- Salou Resort & Spa - Own activities
INSERT INTO hotel_services (id_hotel, id_service) VALUES (4, 3); -- Cambrils Golf & Spa Hotel - Gym
INSERT INTO hotel_services (id_hotel, id_service) VALUES (4, 7); -- Cambrils Golf & Spa Hotel - Free Wi-Fi
INSERT INTO hotel_services (id_hotel, id_service) VALUES (5, 4); -- Valls Historic Inn - Room Service
INSERT INTO hotel_services (id_hotel, id_service) VALUES (5, 5); -- Valls Historic Inn - Pet-Friendly
INSERT INTO hotel_services (id_hotel, id_service) VALUES (5, 8); -- Valls Historic Inn - Own activities
INSERT INTO hotel_services (id_hotel, id_service) VALUES (6, 1); -- PortAventura Hotel - SPA
INSERT INTO hotel_services (id_hotel, id_service) VALUES (6, 2); -- PortAventura Hotel - Swimming Pool
INSERT INTO hotel_services (id_hotel, id_service) VALUES (6, 7); -- PortAventura Hotel - Free Wi-Fi
INSERT INTO hotel_services (id_hotel, id_service) VALUES (6, 8); -- PortAventura Hotel - Own activities