...
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Sigismondo', 'Adrien', 34614307477, 'sadrienj@issuu.com', '$2a$04$91h7n8DPBRRxXs1Czax1tOVRy1Lu8on/Q.8ekMa8haFk4osrgTqpi', 1);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Susanetta', 'Stirley', 34687016590, 'sstirleyk@businesswire.com', '$2a$04$UpVYECsbeCiAFv9o8NO8HOK/0h/48Q59sKDzTHB1m1ainaIIFzWfq', 1);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Allistir', 'Gaukrodge', 34698312296, 'agaukrodgel@sciencedirect.com', '$2a$04$olrX8euXCjPGbGYhnVwMIu/.OcKkMnjTjwKXomRd2P84L3EYvvqRK', 1);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Marge', 'Duhig', 34657308061, 'mduhigm@chronoengine.com', '$2a$04$YXQ/wt.p0399Xvy2qUbqK.RfpyZAWeVUnHcWPdx1fZsroq6T3uBq.', 1);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Massimiliano', 'Bassom', 34697172341, 'mbassomn@youtube.com', '$2a$04$TdKABIJ14cooZsNwM1517ekVhpNhJKft2Amd4X4K8KCVq/fZ4JTtS', 1);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Errol', 'Brownsell', 34616213948, 'ebrownsello@hp.com', '$2a$04$1eGxNrGeDd.0PIyN1tiqZ.PwFOqCcRyxIXt7rcugECGzZhJElr14m', 1);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Fae', 'Scoterbosh', 34632771852, 'fscoterboshp@woothemes.com', '$2a$04$LeWzw3w6YuYXGdidqL5NM.1DbIui/OzE7.rEIvcobEvyiDVvqjO0i', 1);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Rois', 'Baron', 34627863854, 'rbaronq@miibeian.gov.cn', '$2a$04$a38fp5U/QMdTNbbP2ag92uQvja9xRnUZxgXMCZZvHwV8CcYaAFk86', 1);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Dorise', 'Raynes', 34689764181, 'draynesr@icio.us', '$2a$04$TWA6jHRSTHI2cU1DlmIGyu3D7ZLGzt8k90PCnaLmRyiv5iRHxg.gG', 1);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Rosalynd', 'Pirri', 34658397844, 'rpirris@xinhuanet.com', '$2a$04$CZA.ljPatQnhV5JnxD6Ovu0RQdRf1LZ9jYHUJv19HgyoQMWnBLVSK', 1);
-- Insertions of admin users to the users table
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Jessie', 'Effnert', 34618980196, 'jeffnertt@unicef.org', '$2a$04$UcVL6qyJcICeF9VsDsDwrudT4ThvL9aPLvXdcJHdWxMQidDHZHnWW', 2);
INSERT INTO users (`name`, surname, phone, email, `password`, id_role) VALUES ('Costa', 'Haggerstone', 34679494629, 'chaggerstonei@opera.com', '$2a$04$hamFdzqsvp8Y7pdmYtJWrOjhpWokbMBx67UAeO1gfgSPW6YnGuuK6', 2);
...
id_hotel INT,
PRIMARY KEY(id),
FOREIGN KEY (id_hotel) REFERENCES hotel (id) ON UPDATE CASCADE ON DELETE CASCADE,
